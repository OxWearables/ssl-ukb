...
WINDOW_TOL = 0.01  # 1%
DATAFILES = '/data/UKBB/capture24/data/P*.csv.gz'
ANNOLABELFILE = '/data/UKBB/capture24/data/annotation-label-dictionary.csv'
# OUTDIR = 'gertcapture24_100hz_w30_o5/'
OUTDIR = 'gertcapture24_100hz_w30_o0_0t/'
